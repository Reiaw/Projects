...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 08, 2024 at 02:51 PM
...
CREATE TABLE `orders` (
  ...
  `status` enum('pending','paid','shipped','delivered','return_requested','resolved') DEFAULT 'pending',
...
INSERT INTO `product` (`product_id`, `listproduct_id`, `store_id`, `barcode`, `expiration_date`, `status`, `quantity`, `location`, `manufacture_date`, `updated_at`) VALUES
(1, 15, 13, '11428817', '2025-12-31', 'available', 100, 'Aisle 3', '2025-12-31', '2024-10-08 11:24:14');
...
(14, 'กาแฟ Gold Blend', 'กาแฟ', 500.00, 'อะไรสักอย่างลืม', 25, 0x4466645f636f6666656573746f636b2de0b881e0b8b2e0b8a3e0b981e0b888e0b989e0b887e0b980e0b895e0b8b7e0b8ade0b899202831292e6a7067, 1, '2024-10-08 13:19:46'),
...
(54, 'แก้วพลาสติกใส', 'แก้วและภาชนะบรรจุ', 90.00, 'แก้วพลาสติกใสขนาด 16 ออนซ์ พร้อมฝาปิดแบบดัน', 50, NULL, 1, '2024-10-08 08:56:09'),
...
(55, 'suthida', 'Maksee', 'suthida.m@example.com', '$2y$10$VQ/rxAsb778T05pepaaLAuAxowswP0w86NjzFRcMJGf/BC..kj8pC', '0821112345', 'staff', 1, 0, '2024-10-08 06:10:38');
...
--
ALTER TABLE `products_info`
  MODIFY `listproduct_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
